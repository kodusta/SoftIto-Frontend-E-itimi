    ...
    <main className="tracking-container">
      {isSubmitted ? (
        <div className="tracking-card">
          ...
          <button className="form-submit mt-4" onClick={() => { setIsSubmitted(false); setOrderId(''); setEmail(''); setReason(''); setDescription(''); }}>
            Yeni Talep Oluştur
          </button>
        </div>
      ) : (
        <div className="tracking-card">
          ...
          <form onSubmit={handleReturnSubmit}>
            ...
            <button type="submit" className="form-submit">İade Talebi Oluştur</button>
          </form>
      ...
      <div className="tracking-card">
        ...
        <p className="value-desc">2. Size verilecek kargo koduyle ürünü paketleyin.</p>
