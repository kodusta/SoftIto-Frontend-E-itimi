...
function useFieldArray(props) {
	...
	const [fields, setFields] = import_react.useState(disabled ? [] : control._getFieldArray(name));
	const ids = import_react.useRef(disabled ? [] : control._getFieldArray(name).map(generateId));
